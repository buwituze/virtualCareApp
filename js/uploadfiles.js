...
//         alert('Please select a recipient, file, and provide a title.');
//         return;
//     }
...
//         isLink: false,
//         dataUrl: URL.createObjectURL(fileInput) // Create a URL for the file
//     };
...
//         alert('Please select a recipient, enter a file link, and provide a title.');
//         return;
//     }
...
//     const storageKey = recipient === 'patient' ? 'patientFiles' : 'doctorFiles';
//     saveToLocalStorage(fileData, storageKey);
